...
//Kernel operador not
__global__
void operator_or_kernel(const unsigned char* const inputImage, 
                        ...
                        size_t numRows, size_t numCols)
{
  ...
  operator_or_kernel<<<gridSize, blockSize>>>(d_inputImage, d_inputImage2, d_outputImage, numRows, numCols);
